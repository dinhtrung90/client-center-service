...
//@RestController
//@RequestMapping("/api/client-center-service-kafka")
//public class ClientCenterServiceKafkaResource {
//    private final Logger log = LoggerFactory.getLogger(ClientCenterServiceKafkaResource.class);
//
//    private final KafkaProperties kafkaProperties;
//    private KafkaProducer<String, String> producer;
//    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();
//
//    public ClientCenterServiceKafkaResource(KafkaProperties kafkaProperties) {
