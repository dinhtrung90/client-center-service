...
class EmployeeGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Employee entity")
        ...
        .repeat(2) {
            ...
            .get("/services/clientcenterservice/api/employees")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new employee")
            .post("/services/clientcenterservice/api/employees")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                ...
                , "middleInitial":"SAMPLE_TEXT"
                , "emailAddress":"SAMPLE_TEXT"
                , "numberPhone":"SAMPLE_TEXT"
                , "street":"SAMPLE_TEXT"
                , "city":"SAMPLE_TEXT"
                ...
                , "socialSecurityNumber":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/clientcenterservice${new_employee_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created employee")
            .delete("/services/clientcenterservice${new_employee_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
