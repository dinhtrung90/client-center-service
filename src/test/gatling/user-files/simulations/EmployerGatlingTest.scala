...
class EmployerGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Employer entity")
        ...
        .repeat(2) {
            ...
            .get("/services/clientcenterservice/api/employers")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new employer")
            .post("/services/clientcenterservice/api/employers")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/clientcenterservice${new_employer_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created employer")
            .delete("/services/clientcenterservice${new_employer_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
