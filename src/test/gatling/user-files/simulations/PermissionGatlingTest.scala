...
class PermissionGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Permission entity")
        ...
        .repeat(2) {
            ...
            .get("/services/clientcenterservice/api/permissions")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new permission")
            .post("/services/clientcenterservice/api/permissions")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/clientcenterservice${new_permission_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created permission")
            .delete("/services/clientcenterservice${new_permission_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
