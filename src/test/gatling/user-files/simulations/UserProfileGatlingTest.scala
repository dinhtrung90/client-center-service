...
class UserProfileGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the UserProfile entity")
        ...
        .repeat(2) {
            ...
            .get("/services/clientcenterservice/api/user-profiles")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new userProfile")
            .post("/services/clientcenterservice/api/user-profiles")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "id":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/clientcenterservice${new_userProfile_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created userProfile")
            .delete("/services/clientcenterservice${new_userProfile_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
