...
class ClientCenterServiceKafkaResourceIT {
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/client-center-service-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/client-center-service-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
